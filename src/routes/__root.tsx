...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "FluxtonX — Transforming Businesses Through Intelligent Technology" },
      { property: "og:description", content: "FluxtonX partners with global enterprises to deliver architectural precision in digital transformation, cloud-first operations, and AI-driven acceleration." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FluxtonX — Transforming Businesses Through Intelligent Technology" },
      { name: "twitter:description", content: "FluxtonX partners with global enterprises to deliver architectural precision in digital transformation, cloud-first operations, and AI-driven acceleration." },
