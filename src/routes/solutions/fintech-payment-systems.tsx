...
function FintechPaymentSystems() {
  return (
      ...
      <main className="pt-16">
        ...
        <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed">
              Secure, compliant, and high-performance financial technology solutions and payment gateway integrations
            </p>
        ...
        <section className="py-24 bg-white dark:bg-gray-900">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: CreditCard, title: "Payment Gateway Integration", desc: "Seamless integration with global payment providers like Stripe, PayPal, and Adyen." },
                { icon: ShieldCheck, title: "PCI DSS Compliance", desc: "Ensuring your financial data handling meets the highest industry security standards." },
                { icon: Zap, title: "Real-Time Transactions", desc: "Building low-latency systems for instantaneous payment processing and ledger updates." },
                { icon: Globe, title: "Multi-Currency Support", desc: "Architecting systems that handle global transactions across various currencies and jurisdictions." },
              ].map((item, i) => (
        ...
        <section className="py-24 bg-white dark:bg-gray-900">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { icon: BarChart, title: "Security-First Focus", desc: "We prioritize data protection and compliance in every line of financial code." },
                { icon: Settings, title: "Legacy Modernization", desc: "We help bridge the gap between old banking systems and modern fintech APIs." },
                { icon: Users, title: "Domain Expertise", desc: "Our team understands the regulatory and technical nuances of the fintech landscape." },
              ].map((item, i) => (
        ...
        <section className="bg-blue-600 py-20 text-center">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-blue-100">Let's discuss how we can revolutionize your financial services.</p>
